    ...
    return (
        <div className='flex items-center justify-center flex-grow'>
            <div className='max-w-[1140px] mx-auto px-3 '>
                <h2 className='font-anton text-[44px] sm:text-[72px] font-normal text-[#ffffff] mx-auto  lg:max-w-[505px] leading-[54px] sm:leading-[86px] text-center uppercase'>Exclusive Games. Pasión por ganar</h2>
