    ...
    return (
        <>
            <div className='relative z-[2]'>
                <div className='max-w-[1140px] mx-auto px-3 mt-12 sm:mt-28 '>
                    <h2 className='font-anton font-normal text-[42px] sm:text-[48px]  text-[#FFFF] leading-[57px] text-center' data-aos="fade-up"
                        data-aos-offset="300"
                        data-aos-easing="ease-in-sine">Juegos en vivo</h2>
                    <div className='flex flex-row flex-wrap -mx-3 mt-14 justify-center'>
                        <div className='lg:w-4/12 sm:w-1/2 w-[90%] px-3 group flex justify-center' data-aos="fade-left"
                            data-aos-offset="300"
                ...
                <img src={skyb} alt="sky3" className='absolute bottom-[-116%] right-[0%] z-[-1]  hidden md:block' />
            </div>
        </>
    )
}
