                    ...
                    <div className='max-w-[1140px] px-3 mx-auto py-12 mt-10 lg:mt-0'>
                        <div className='flex flex-wrap flex-row -mx-3'>
                            ...
                            <div className='lg:w-1/2 w-full px-3 flex  flex-col items-center lg:items-start pt-8 lg:pt-0'>
                                ...
                                <div className=' p-[0.5px] max-w-[374px] h-[116px] rounded-[16px] mt-12'>
                                    <div className='max-w-[374px] gradient2 h-[116px] rounded-[16px] border-[0.5px] border-solid bg-[#00141b] p-[24px_56px_24px_56px] gap-[37px]'>
                                ...
                                <div className=' p-[0.5px] max-w-[374px] h-[116px] rounded-[16px] mt-6'>
                                    <div className='max-w-[374px] gradient2 h-[116px] rounded-[16px] border-[0.5px] border-solid bg-[#00141b] p-[24px_56px_24px_56px] gap-[37px]'>
                                        <div className='flex items-center gap-10'>
                                ...
                                <div className=' p-[0.5px] max-w-[374px] h-[116px] rounded-[16px] mt-6'>
                                    <div className='max-w-[374px] gradient2 h-[116px] rounded-[16px] border-[0.5px] border-solid bg-[#00141b] p-[24px_56px] gap-[37px]'>
                                        <div className='flex items-center gap-10'>
