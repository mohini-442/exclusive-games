            ...
            <div className="max-w-[1140px] mx-auto px-3 py-5">
                <div className="flex items-center justify-between">
                    ...
                    <li className='lg:block hidden '>
                        <a href="" className='p-[13px_46px_13px_46px] text-base font-bold font-inter text-[#FFFFFF] border-solid border-[1px] rounded-[41px] gap-[10px] duration-[0.5s]  relative after:absolute after:content-[url(./assets/images/wline.png)] after:top-[26px] after:left-[-6px] '>Acceso</a>
                    </li>
