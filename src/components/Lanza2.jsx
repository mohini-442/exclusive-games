    ...
    return (
        <>
            <div className='max-w-[1140px] mx-auto px-3 lg:py-32 pb-12' data-aos="fade-up"
                ...
                <div className='bg-[url(./assets/images/lanza2.webp)] mx-[8%] sm:mx-auto bg-no-repeat bg-center  flex items-center justify-center max-w-[1140px] h-[341px] rounded-[16px] border-[0.5px] border-solid border-white flex-col'>
