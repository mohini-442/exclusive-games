...
const Silver = () => {
    return (
        <>
            <div className='max-w-[1140px] px-3 mx-auto pt-12 sm:pb-12' data-aos="fade-up"
                data-aos-offset="300"
                data-aos-easing="ease-in-sine">
                <h2 className='md:text-[48px]  text-[38px] font-normal font-anton text-white text-center'>Nuestras ofertas</h2>
                ...
                <div className='max-w-[1140px] mt-14 bg-gradient2 relative z-2 border-[0.5px] border-solid border-[#828592] rounded-[16px] p-[57px_40px_32px_46px]'>
                    <div className='flex flex-wrap flex-row -mx-3'>
                        <div className='lg:w-7/12 w-full px-3 pt-5 flex justify-center lg:justify-start'>
                            <div className='relative z-[2]'>
                                <img className='pt-4' src={cards} alt="cards" />
                        ...
                        <div className='lg:w-5/12 w-full px-3 flex  flex-col items-center lg:items-start text-center lg:text-start'>
                            ...
                            <h2 className='text-[48px] font-normal text-white font-anton pt-4'>$5000</h2>
                            <div className='max-w-[426px]'>
                                <div className='flex gap-2 pt-3'>
                                    ...
                                    <p className='text-[16px] font-medium text-[#CDD2D3] font-inter'>Disponibles Payku, Pix, Depósitos en Euros, Criptomonedas, Cargas manuales</p>
                                </div>
                                <div className='flex gap-2 pt-3'>
                                    <span>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className='text-[16px] font-medium text-[#CDD2D3] font-inter'>Control de RTP (controlás qué porcentaje pagar)</p>
                                </div>
                                <div className='flex gap-2 pt-3'>
                                    <span>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className='text-[16px] font-medium text-[#CDD2D3] font-inter'>Bonos Editables, Happy Hours, Jackpots, Códigos Promocionales Regalo</p>
                                </div>
                                <div className='flex gap-2 pt-3'>
                                    <span>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className='text-[16px] font-medium text-[#CDD2D3] font-inter'>Aplicación para Android y Windows de regalo.</p>
                                </div>
                                <div className='flex gap-2 pt-3'>
                                    <span>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
